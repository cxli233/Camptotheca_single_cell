#!/bin/bash
#SBATCH --job-name=caa_stem_pip_starsolo-BP	# Job name
...
cd /scratch/cl56619/Cam_stem_v4/Data/camptotheca_stem_pipseq/CAA_BP

#STARsolo alignment
STAR --genomeDir /scratch/cl56619/Cam_stem_v4/Data/caac_v4_star_ref \
--readFilesIn CAA_BP_all_barcoded_R2.fastq CAA_BP_all_barcoded_R1.fastq \
--runThreadN 24 \
--alignIntronMax 5000 \
...
--soloCBwhitelist /scratch/cl56619/Cam_stem_v4/Data/camptotheca_stem_pipseq/CAA_BP/barcode_whitelist.txt \
--outSAMtype BAM SortedByCoordinate \
--limitBAMsortRAM 26843545600 \
--soloOutFileNames CAA_BP
