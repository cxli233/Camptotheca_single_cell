#!/bin/bash
#SBATCH --job-name=caa_multi_gex_starsolo-BG	# Job name
...
cd /scratch/cl56619/caa_multiome_v4/Data/GEX_fq_repair/CAA_BG

#STARsolo alignment
STAR --genomeDir /scratch/cl56619/caa_multiome_v4/Data/caac_v4_star_ref \
--readFilesIn CAA_BG_R2.trim.fastq CAA_BG_R1.fastq \
--runThreadN 24 \
--alignIntronMax 5000 \
